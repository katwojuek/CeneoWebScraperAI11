...
def product(product_id):
    ...
    return render_template("product.html", product_id=product_id, opinions=opinions.to_html(classes="table table-hover table-stripped", index=False, table_id = "opinions"))
